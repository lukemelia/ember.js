...
Ember.Route = Ember.Object.extend({
  ...
  */
  ...
  init: function() {
    ...
    if (this.events === null) {
      this.events = {}; //TODO: how to make this play nicely with mergeProperties?
    }
    ...
    for (name in proto) {
      ...
      handler = proto[name];
      if (handler && handler.__eventHandler__) {
  ...
  /**
    ...
    ## Alternate way to define events

    You can also define a method on the route object to be an event
    like so:
    ...
    Use `Ember.Route.event()` if you are using Ember without
